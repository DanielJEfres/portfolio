...
export default function AboutMe() {
    ...
    return (
        <div className="mt-4 md:mt-32 md:mb-32 animate duration-500">
            ...
            <h1 className="flex mx-auto justify-center text-3xl text-[#23282e] font-mono mb-16 md:mb-24 mt-10 underline decoration-blue-400 underline-offset-4 decoration-2">
                Skills
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-8">
                ...
                {Languages.map((lang) => (
                    <div key={lang.name} className="group relative border-2 border-[#6a6b6d] bg-sky-100 shadow-md rounded-lg flex justify-center items-center hover:scale-110 transform transition-all duration-300">
            ...
            <div className="flex flex-wrap justify-center gap-8 py-8">
                ...
                {Frameworks.map((framework) => (
                    <div key={framework.name} className="group relative border-2 border-[#6a6b6d] bg-sky-100 shadow-lg rounded-md flex justify-center items-center hover:scale-110 transform transition-all duration-300">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-16">
                ...
                {Tools.map((tool) => (
                    <div key={tool.name} className="group relative border-2 border-[#6a6b6d] bg-sky-100 shadow-lg rounded-md flex justify-center items-center hover:scale-110 duration-300">
